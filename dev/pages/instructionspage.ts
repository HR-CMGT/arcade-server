class InstructionsPage extends HTMLElement implements InputListener {
    
    constructor() {
        super()

        let container = document.querySelector("#content-page")! as HTMLElement
        let template: HTMLTemplateElement = document.getElementById('instructionspage')! as HTMLTemplateElement
